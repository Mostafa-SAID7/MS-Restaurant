    ...
    <section ref={ref} id="reviews" className="bg-cream px-6 py-12 sm:py-16">
      <div className={`motion-reveal mx-auto max-w-6xl ${isVisible ? "is-visible" : ""}`}>
        ...
        <div className="mt-[60px] text-center">
          <button
            type="button"
            className="button-depth rounded-xl border-[1.5px] border-ink px-8 py-2.5 font-display text-[clamp(9px,1.1vw,12px)] tracking-[0.28em] text-ink transition-colors duration-200 hover:bg-ink hover:text-cream"
          >
            READ MORE ABOUT ME
          </button>
        </div>
