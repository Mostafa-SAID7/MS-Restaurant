        ...
        <div>
          ...
          >
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded-xl border-2 border-cream/25 bg-transparent px-4 py-2 font-oswald text-sm text-cream placeholder:text-cream/40 focus:border-signal focus:outline-none"
            />
            <button
              type="submit"
              className="button-depth shrink-0 rounded-xl bg-signal px-5 py-2 font-heavy text-xs tracking-[0.1em] text-cream uppercase"
            >
              Join
            </button>
          </form>
