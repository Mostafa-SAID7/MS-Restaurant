      ...
      <div className="relative flex justify-center px-4">
        ...
        >
          ...
          <div className="khida-card relative mx-auto mt-9 w-full max-w-[280px] bg-cream px-5 py-[18px] shadow-[6px_6px_0_var(--ink)] transition-transform duration-300 hover:-translate-y-1 hover:rotate-[-1.5deg] sm:absolute sm:top-[clamp(20px,3.2vw,40px)] sm:right-[clamp(20px,3.5vw,48px)] sm:mx-0 sm:mt-0 sm:w-[clamp(132px,17.5vw,178px)]">
            ...
            <button
              type="button"
              className="button-depth mb-2.5 w-full cursor-pointer rounded-xl bg-ink px-3 py-2.5 text-center transition-colors hover:bg-signal-dark"
            >
          ...
          <div className="mt-8">
            <button
              type="button"
              className="button-depth khida-dashed inline-flex items-center gap-2 rounded-xl border-2 border-dashed border-cream/55 bg-transparent px-7 py-[11px] font-display text-[clamp(10px,1.3vw,13px)] tracking-[0.22em] text-cream transition-colors hover:bg-cream/10"
            >
